...
public class Activity_MyDriver_Repair extends Activity implements OnClickListener,DrawableRightListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mydriver_repair);
		ImageView btn_back=(ImageView)findViewById(R.id.btn_back);
		btn_back.setOnClickListener(this);
		TextView tv_title=(TextView)findViewById(R.id.tv_title);
		tv_title.setText("我要修车");
	...
	public void onClick(View v) {
		if(v.getId()==R.id.btn_back){
			...
			if(start==null){
				...
				MyUtil.alert("请输入您车的问题",this);
			}else{
				Intent intent=new Intent(this,Activity_MyDriver_Repair_Detail.class);
