...
public class Activity_Handler_Dingzhi  extends Activity implements OnClickListener,DrawableRightListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_handler_dingzhi);
	...
	public void onClick(View v) {
		if(v.getId()==R.id.btn_back){
			...
			if(start==null){
				...
				return;
			}else if(tv_message.getText().toString().trim().equals("")){
				MyUtil.alert("请输入办事说明", this);
				return;
			}else{
				Intent intent=new Intent(this,Activity_Handler_Dingzhi_Detail.class);
