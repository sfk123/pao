 ...
 *
 */
public class Activity_Homemaking  extends Activity implements OnClickListener,DrawableRightListener{
	...
	public void onClick(View v) {
		if(v.getId()==R.id.btn_back){
			...
			if(start==null){
				...
				Intent intent=new Intent(this,Activity_HomeMaking_confirm.class);
