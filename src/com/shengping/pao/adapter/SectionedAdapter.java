...
public class SectionedAdapter extends SectionedBaseAdapter {
	...
	public SectionedAdapter(Map<String,List<Food>> food_maplist,List<String> foodType,Context context){
	...
	public View getItemView(int section, int position, View convertView,
		...
		imageloader.displayImage(food.getImage(), holder.food_image, options);
