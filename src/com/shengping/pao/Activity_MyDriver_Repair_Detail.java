...
public class Activity_MyDriver_Repair_Detail extends Activity implements OnClickListener{
	private ImageView img_select_1,img_select_2,img_select_3,img_select_4;
	private TextView tv_start,tv_phone,tv_detail;
	private String pay_type="pay_normal";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_mydriver_repair_detail);
